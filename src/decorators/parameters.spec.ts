...
describe( '@Path', () => {
  ...
  it( 'resolve Path variable', ( done: ( e?: any ) => void ) => {
    ...
    let requestMock = new HttpMock( ( req: HttpRequest<any> ) => {
      return Observable.of( new HttpResponse<any>( { url: req.url } ) );
    } );
...
describe( '@Query', () => {
  ...
  it( 'resolve Query variable', ( done: ( e?: any ) => void ) => {
    // Arrange
    let requestMock = new HttpMock( ( req: HttpRequest<any> ) => {
      return Observable.of( new HttpResponse<any>( { url: req.urlWithParams } ) );
    } );
...
describe( '@Header', () => {
  ...
  it( 'resolve Header variable', ( done: ( e?: any ) => void ) => {
    // Arrange
    let requestMock = new HttpMock( ( req: HttpRequest<any> ) => {
      return Observable.of( new HttpResponse<any>( { headers: req.headers } ) );
    } );
...
describe( '@Body', () => {
  ...
  it( 'resolve Body variable', ( done: ( e?: any ) => void ) => {
    // Arrange
    let requestMock = new HttpMock( ( req: HttpRequest<any> ) => {
      return Observable.of( new HttpResponse<any>( { body: req.body } ) );
    } );
